...
variable "dest_type" {
  description = "If dest_type is specified, module will attempt to create the lan_interface, otherwise the module will only create a  the SocketInterface destination type (https://api.catonetworks.com/documentation/#definition-SocketInterfaceDestType)"
  type        = string
  default     = null
}
